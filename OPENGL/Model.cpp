...
void Model::loadModel(std::string const& path)
{
    ...
    //std::cout << "sussceed"<<directory << std::endl;
...
unsigned int Model::GenerateTex(unsigned char* data, int width, int height, int nrComponents, bool gama)
{
    unsigned int textureID;
    glGenTextures(1, &textureID);
...
unsigned int Model::TextureFrom_FBX_EmbeddedTexture(const aiTexture* aiTex, bool gama)
{
    ...
    {
        std::cout << "Texture FBX failed to load at path: " << std::endl;
        stbi_image_free(data);
    }
